...
class _SplashScreenState extends State<SplashScreen> {
  ...
  void _navigateToHome() {
    Navigator.pushReplacement(
      ...
      // MaterialPageRoute(
      //   builder:
      //       (context) => VideoPlayerBuilder.createHLSPlayer(
      //         m3u8Url: 'http://192.168.3.84:9010/hls/2025/08/28/a49edee4335e58391c4044ecbc34e3ff2106521877ff483bdb840e2db92f8306/1961128069760090112.m3u8',
      //         keyUri: 'https://your-server.com/key',
      //         autoPlay: true,
      //       ),
      // ),
    );
